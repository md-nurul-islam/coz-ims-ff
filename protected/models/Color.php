...
class Color extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('name', 'required'),
            array('name, hex_code', 'unique'),
            array('name', 'length', 'max' => 120),
            array('hex_code', 'length', 'max' => 7),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, hex_code', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function dataGridHeaders() {
        return array(
            ...
            'hex_code' => array('label' => 'Code', 'sortable' => 'true', 'width' => 180),
    ...
    public function dataGridFilters() {
        return array(
            ...
            'hex_code' => array('id' => 'hex_code', 'class' => 'easyui-textbox', 'label' => 'Code: ', 'style' => 'width:80px;'),
        );
    }
