    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">Advance Sale Payment</h4>
            </div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                            ...
                            <tbody id="payment-cart-row">
                                ...
                                <tr>
                                    <th colspan="2" class="col-sm-12">
                                        <span class="pull-left">Total Due</span>
                                        <span class="pull-right" id="payment-total-due"></span>
                                    </th>
                                </tr>
                            </tbody>
                    ...
                    <div class="form-group">
                        <?php echo CHtml::label('Advance Amount', 'advance_amount', array('class' => 'col-sm-3 control-label')); ?>
                        <div class="col-sm-9">
                            <?php
                            echo CHtml::textField('advance_amount', '', array(
                                'class' => 'form-control text-bold text-right',
                                'placeholder' => 'Amount in advance (60%) of the total.',
                                'id' => 'advance_amount'
                            ));
                            ?>
                        </div>
