                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    if (Yii::app()->user->isSuperAdmin) {
                                        $type = 1;
                                    } elseif (Yii::app()->user->isStoreAdmin) {
                                        $type = 2;
                                    }
                                    ?>
                                    <?php echo Yii::app()->user->name; ?> - <?php echo Settings::$_user_types[$type]; ?>
                                </p>
                            </li>
                        <?php } ?>
                        <!-- Menu Body -->
