...
class ColorsController extends Controller {
    ...
    public function actionCreate() {
        ...
        $this->pageHeader = 'Add Color';
        $this->pageTitle = Yii::app()->name . ' - Add Color';
        ...
        if (isset($_POST['Color'])) {
            ...
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'Color successfully added.');
    ...
    public function actionUpdate($id) {
        ...
        $this->pageTitle = Yii::app()->name . ' - Update Color';
        $this->pageHeader = 'Update Color';
        ...
        if (isset($_POST['Color'])) {
            ...
            if ($model->save())
                Yii::app()->user->setFlash('success', 'Color successfully updated.');
    ...
    public function actionIndex() {
        ...
        $this->pageTitle = Yii::app()->name . ' - Color List';
        $this->pageHeader = 'Color List';
    ...
    public function actionGetdata() {
        ...
        $result['rows'] = $Color->dataGridRows($query_params);
